...
static const _NodeMessage_type_support_symbol_names_t _NodeMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, stretch_sensor_msgs, msg, NodeMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, stretch_sensor_msgs, msg, NodeMessage)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, stretch_sensor_msgs, msg, NodeMessage)() {
  return &::stretch_sensor_msgs::msg::rosidl_typesupport_c::NodeMessage_message_type_support_handle;
}
