...
static const _NodeMessage_type_support_symbol_names_t _NodeMessage_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, stretch_sensor_msgs, msg, NodeMessage)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, stretch_sensor_msgs, msg, NodeMessage)),
  }
};
...
{
  return &::stretch_sensor_msgs::msg::rosidl_typesupport_cpp::NodeMessage_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, stretch_sensor_msgs, msg, NodeMessage)() {
  return get_message_type_support_handle<stretch_sensor_msgs::msg::NodeMessage>();
}
